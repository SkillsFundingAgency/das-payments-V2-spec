...
Scenario Outline: Capping - Payment for Levy learner with a negotiated price above funding cap PV2-528	
	...
	And the following commitments exist
		| start date                   | end date                  | agreed price | status | effective from               | Framework Code | Pathway Code | Programme Type |
		| 01/Aug/Current Academic Year | 01/Aug/Next Academic Year | 18000        | active | 01/Aug/Current Academic Year | 593            | 1            | 20             |
