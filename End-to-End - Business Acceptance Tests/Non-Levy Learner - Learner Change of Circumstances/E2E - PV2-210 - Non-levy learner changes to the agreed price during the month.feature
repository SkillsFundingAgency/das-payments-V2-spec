#Scenario:Non-Levy learner, and there is a change to the agreed price which happens in the middle of the month
#		
...
Feature: Non-Levy learner, and there is a change to the agreed price which happens in the middle of the month
