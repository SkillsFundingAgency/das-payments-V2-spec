...
Feature: Inconsistent Submission Data
As a provider,
I want a 19-24 yr old Levy learner, where the small employer flag is added but the care leaver flag is removed retrospectively from the ILR, and previous on-programme payments are refunded and repaid according to the latest care leaver status
So that I am accurately paid the apprenticeship amount by SFA PV2-655

Scenario: 19-24 year old Levy apprentice, small employer flag added, provider retrospectively removes care leaver flag in the ILR, previous on-programme payments are refunded and repaid according to latest care leaver status PV2-655
...
And the provider previously submitted the following learner details
    ...
    | 1        | 04/Aug/Current Academic Year | 12 months        | 8000                 | 01/Aug/Current Academic Year        | 1000                  | 01/Aug/Current Academic Year         |                 | continuing        | 100%                        | Act1          | 1                   | ZPROG001      | 17            | 25             | EEF4        | 19-24 Apprenticeship (From May 2017) Levy Contract |
