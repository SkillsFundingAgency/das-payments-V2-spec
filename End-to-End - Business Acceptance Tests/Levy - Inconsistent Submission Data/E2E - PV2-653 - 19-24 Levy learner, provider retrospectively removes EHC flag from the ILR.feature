...
Feature: Inconsistent Submission Data
As a provider,
I want a 19-24 yr old Levy learner, where the small employer flag is added but the Education Health Care (EHC) plan flag is retrospectively removed from the ILR, and previous on-programme payments are refunded and repaid according to the latest EHC plan status
So that I am accurately paid the apprenticeship amount by SFA PV2-653

Scenario: 19-24 year old Levy apprentice, small employer flag added, provider retrospectively removes Education Health Care (EHC) plan flag in the ILR, previous on-programme payments are refunded and repaid according to latest EHC plan status PV2-653
...
And the provider previously submitted the following learner details
    ...
    | 1        | 04/Aug/Current Academic Year | 12 months        | 8000                 | 01/Aug/Current Academic Year        | 1000                  | 01/Aug/Current Academic Year         |                 | continuing        | 100%                        | Act1          | 1                   | ZPROG001      | 17            | 25             | EEF2        | 19-24 Apprenticeship (From May 2017) Levy Contract |
...
But the Provider now changes the Learner details as follows
    ...
    | 04/Aug/Current Academic Year | 12 months        | 9000                 | 01/Aug/Current Academic Year        | 01/Aug/Current Academic Year         |                 | continuing        | 90%                         | Act1          | 1                   | ZPROG001      | 17            | 25             | No value    | 19-24 Apprenticeship (From May 2017) Levy Contract |
...
And only the following provider payments will be recorded
    ...
    | R06/Current Academic Year | Jan/Current Academic Year | 0                         | 600           | Learning         |
