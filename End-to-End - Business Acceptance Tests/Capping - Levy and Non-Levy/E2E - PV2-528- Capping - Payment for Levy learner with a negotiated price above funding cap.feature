...
Scenario Outline: Capping - Payment for Levy learner with a negotiated price above funding cap PV2-528
	...
	# New capping line
	And the funding cap is 15000
	And the following commitments exist
    | commitment Id | version Id | Provider   | ULN       | start date | end date   | agreed price | standard code | status | effective from |
    | 1             | 1          | provider a | learner a | 01/08/2018 | 01/08/2019 | 18000        | 50            | active | 01/08/2018     |	
    And the provider is providing training for the following learners
		| Start Date                   | Planned Duration | Total Training Price | Total Training Price Effective Date | Total Assessment Price | Total Assessment Price Effective Date | Actual Duration | Completion Status | Contract Type | Aim Sequence Number | Aim Reference | Standard Code | Programme Type | Funding Line Type                                  | SFA Contribution Percentage |
		| 06/Aug/Current Academic Year | 12 months        | 15000                | 06/Aug/Current Academic Year        | 3000                   | 06/Aug/Current Academic Year          |                 | continuing        | Act1          | 1                   | ZPROG001      | 51            | 25             | 16-18 Apprenticeship (From May 2017) Levy Contract | 90%                         |
...
Examples: 
        ...
        | R09/Current Academic Year | 7000         |
        | R10/Current Academic Year | 6000         |
        | R11/Current Academic Year | 5000         |
