...
#
#Feature: Provider earnings and payments where learner changes apprenticeship standard and there is a *no* change to the negotiated price at the end of a month, (remaining with the same employer and provider)
#			
# Background:
#	
