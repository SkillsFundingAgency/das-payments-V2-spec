...
Scenario Outline: Levy learner changes to the agreed price at the end of the month PV2-294
	...
	And the following aims
		| Start Date                   | Planned Duration | Actual Duration | Aim Sequence Number | Programme Type | Standard Code | Funding Line Type         | Completion Status |
		| 01/Aug/Current Academic Year | 12 months        |                 | 1                   | 25             | 51            | 19-24 Apprenticeship Levy | continuing        |
