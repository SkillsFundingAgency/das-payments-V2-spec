...
#19-24 programme only non-DAS | EEF2        | 
# Note: EHC plans are flagged on the ILR through Eligibility for Enhanced Funding (EEF) code = 2*

Scenario: Non-levy learner 19-24 with an Education Health Care (EHC) plan employed with a small employer at start fully funded PV2-328
