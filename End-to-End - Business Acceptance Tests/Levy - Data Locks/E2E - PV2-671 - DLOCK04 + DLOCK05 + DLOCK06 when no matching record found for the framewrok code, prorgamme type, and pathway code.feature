...
So that I can correct the data mis-match between the Commitment and ILR  PV2-671
	...
	Scenario Outline: DLOCK04 + DLOCK05 + DLOCK06 - When no matching record found in an employer digital account for for the framework code and programme type then datalock DLOCK_04 and DLOCK05 will be produced PV2-670
		...
		| learner a  | 01/May/Last Academic Year | 15 months        | 10000                | 01/May/Last Academic Year           | continuing        | Act1          | 1                   | ZPROG001      | 589            | 21             | 3            | 16-18 Apprenticeship (From May 2017) Levy Contract | 90%                         |
		...
		Then the following data lock event is returned
			 ...
			 | 21-589-3-01/May/Last Academic Year | 73                | learner a  | 01/May/Last Academic Year | 10000              |
		# New steps /lines for datalocks	  
		And the data lock event has the following errors:    
		      | Price Episode identifier           | Error code | Error Description                                                               |
		      | 21-589-3-01/May/Last Academic Year | DLOCK_04   | No matching record found in the employer digital account for the framework code |
		      | 21-589-3-01/May/Last Academic Year | DLOCK_05   | No matching record found in the employer digital account for the programme type |
		      | 21-589-3-01/May/Last Academic Year | DLOCK_06   | No matching record found in the employer digital account for the pathway code   |
		  
		And the data lock event has the following periods:  
		      | Price Episode identifier | Period   | Payable Flag | Transaction Type |
		      |21-589-3-01/May/Last Academic Year       | 1718-R10 | false        | Learning         |
		      |21-589-3-01/May/Last Academic Year       | 1718-R11 | false        | Learning         |
		      |21-589-3-01/May/Last Academic Year       | 1718-R12 | false        | Learning         |
		  
		And the data lock event used the following commitments:
		      | Price Episode identifier           | Apprentice Version | Start Date                | framework code | programme type | pathway code | Negotiated Price | Effective Date            |
		      | 21-589-3-01/May/Last Academic Year | 73-125             | 01/May/Last Academic Year | 593            | 20             | 1            | 10000            | 01/May/Last Academic Year |
