...
Scenario: DLOCK04 - When no matching record found in an employer digital account for for the framework code then datalock DLOCK_04 will be produced PV2-665
	...
	And the following data lock failures were generated
        ...
        | Apprenticeship a | 01/May/Current Academic Year | May/Current Academic Year | 589            | 20             | 1            | Learning         | DLOCK_04   | pe-1                     |
		| Apprenticeship a | 01/May/Current Academic Year | Jun/Current Academic Year | 589            | 20             | 1            | Learning         | DLOCK_04   | pe-1                     |
		| Apprenticeship a | 01/May/Current Academic Year | Jul/Current Academic Year | 589            | 20             | 1            | Learning         | DLOCK_04   | pe-1                     |
