...
Feature: DLOCK01 - no matching record found for UKPRN - PV2-662
		As a provider,
...
Scenario: DLOCK01 - When no matching record found in an employer digital account for the UKPRN then datalock DLOCK_01 will be produced PV2-662
    ...
    And the following data lock failures were generated
        | Apprenticeship    | Learner ID | ILR Start Date               | Delivery Period           | Framework Code | Programme Type | Pathway Code | Transaction Type | Error Code | Price Episode Identifier |
        | No Apprenticeship | learner a  | 01/May/Current Academic Year | May/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_01   | pe-1                     |
        | No Apprenticeship | learner a  | 01/May/Current Academic Year | Jun/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_01   | pe-1                     |
        | No Apprenticeship | learner a  | 01/May/Current Academic Year | Jul/Current Academic Year | 593            | 20             | 1            | Learning         | DLOCK_01   | pe-1                     |
