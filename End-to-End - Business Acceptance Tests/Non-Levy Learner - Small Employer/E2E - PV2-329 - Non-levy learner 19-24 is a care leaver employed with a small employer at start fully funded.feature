#@SmallEmployerNonDas
#Scenario:AC3- 1 learner aged 19-24, non-levy, is a care leaver, In paid employment with a small employer at start, is fully funded for on programme and completion payments
#
...
#        | learner a | 19-24 programme only non-DAS | 7500         | 06/08/2018 | 08/08/2019       | 08/08/2019      | completed         | 403            | 2              | 1            | In paid employment | 05/08/2018                | 12345678    | SEM1           | EEF4        |
#	
...
Scenario Outline: Non-levy learner 19-24 is a care leaver employed with a small employer at start fully funded PV2-329
#Note: care leavers are flagged on the ILR through EEF code = 4*
#Confirm funding line type - if this should be 19-24 or 16-18 is OK??
	Given the provider previously submitted the following learner details
		...
		| 1        | 06/Aug/Last Academic Year | 12 months        | 7500                 | 06/Aug/Last Academic Year           | 0                      | 06/Aug/Last Academic Year             |                 | continuing        | Act2          | 1                   | ZPROG001      | 403            | 1            | 25             | 19-24 programme only non-DAS | EEF4        | 19-24 Apprenticeship (From May 2017) Non-Levy Contract (non-procured) | 100%                        |
	And the employment status in the ILR is:
        | Employer   | Employment Status  | Employment Status Applies | Small Employer |
    ...
    But the Provider now changes the Learner details as follows
		| Priority | Start Date                | Planned Duration | Total Training Price | Total Training Price Effective Date | Total Assessment Price | Total Assessment Price Effective Date | Actual Duration | Completion Status | Contract Type | Aim Sequence Number | Aim Reference | Framework Code | Pathway Code | Programme Type | Learner Type                 | LearnDelFAM | Funding Line Type                                                     | SFA Contribution Percentage |
		| 1        | 06/Aug/Last Academic Year | 12 months        | 7500                 | 06/Aug/Last Academic Year           | 0                      | 06/Aug/Last Academic Year             | 12 months       | completed         | Act2          | 1                   | ZPROG001      | 403            | 1            | 25             | 19-24 programme only non-DAS | EEF4        | 19-24 Apprenticeship (From May 2017) Non-Levy Contract (non-procured) | 100%                        |
	And the employment status in the ILR is:
        | Employer   | Employment Status  | Employment Status Applies | Small Employer |
        | employer 1 | in paid employment | 05/Aug/Last Academic Year | SEM1           |
