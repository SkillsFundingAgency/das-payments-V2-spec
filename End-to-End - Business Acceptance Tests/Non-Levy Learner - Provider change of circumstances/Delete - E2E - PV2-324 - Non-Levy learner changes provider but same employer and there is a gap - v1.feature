...
Scenario Outline: Non-Levy learner changes provider but remains with the same employer and there is a gap PV2-324
	Given multiple providers are providing training for the following learners
        ...
        | provider b | 06/Jun/Current Academic Year | 5 months         | 3000                 | 06/Jun/Current Academic Year        | 500                   | 06/Jun/Current Academic Year         |                 | continuing        | Act2          | 1                   | ZPROG001      | 403            | 1            | 25             | 16-18 Apprenticeship (From May 2017) Non-Levy Contract (non-procured) | 90%                         |
