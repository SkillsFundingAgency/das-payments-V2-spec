...
Scenario Outline: Non-Levy learner changes provider but remains with the same employer PV2-325
	...
	Given multiple providers are providing training for the following learners
        ...
        | provider b | 1        | 05/Mar/Current Academic Year | 5 months         | 3000                 | 05/Mar/Current Academic Year        | 500                   | 05/Mar/Current Academic Year         |                 | continuing        | Act2          | 1                   | ZPROG001      | 403            | 1            | 25             | 16-18 Apprenticeship (From May 2017) Non-Levy Contract (non-procured) | 90%                         |
