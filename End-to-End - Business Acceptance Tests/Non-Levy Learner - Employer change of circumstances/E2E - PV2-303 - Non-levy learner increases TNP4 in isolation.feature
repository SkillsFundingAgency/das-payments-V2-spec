...
Scenario Outline:	Non-levy learner increases TNP4 in isolation (no change to TNP3) PV2-303	
	...
	But the Provider now changes the Learner details as follows
        | Priority | Start Date                   | Planned Duration | Residual Training Price | Residual Training Price Effective Date | Residual Assessment Price | Residual Assessment Price Effective Date | Actual Duration | Completion Status | Contract Type | Aim Sequence Number | Aim Reference | Programme Type | Standard Code | Funding Line Type                                                     | SFA Contribution Percentage |
        | 1        | 05/Aug/Current Academic Year | 12 months        | 12000                   | 05/Aug/Current Academic Year           | 4000                      | 15/Nov/Current Academic Year             |                 | continuing        | Act2          | 1                   | ZPROG001      | 25             | 11            | 16-18 Apprenticeship (From May 2017) Non-Levy Contract (non-procured) | 90%                         |
