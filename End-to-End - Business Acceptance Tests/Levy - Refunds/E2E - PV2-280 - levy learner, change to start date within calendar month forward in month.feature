...
Scenario:  For a DAS-Learner, the start date of apprenticeship is moved forward within a calendar month PV2-280
	...
	And the provider previously submitted the following learner details
        ...
        | learner a | 1        | 05/Aug/Current Academic Year | 12 months        | 9000                 | Aug/Current Academic Year           | continuing        | 0                           | ContractWithEmployer | 1                   | ZPROG001      | 403            | 2              | 1            | 16-18 Apprenticeship (From May 2017) Levy Contract |
