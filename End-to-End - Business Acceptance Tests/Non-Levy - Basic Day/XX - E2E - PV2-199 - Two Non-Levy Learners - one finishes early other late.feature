...
Scenario Outline: 2 non-LEVY learners, one learner finishes early, one finishes late PV2-199
	Given the provider previously submitted the following learner details
        ...
        | ULN       | Delivery Period        | On-Programme | Completion | Balancing | Funding Line Type                                                     | SFA Contribution Percentage |
