...
#levy learner, levy available, commitment entered for a new employer in the middle of the month, and there is a change to the employer and negotiated cost in the middle of a month in the ILR
...
Scenario Outline: Levy learner changes employer with change to negotiated price in mid month PV2-363
	...
	# Additional fields
        | Employer   | commitment Id | version Id | ULN       | start date                   | end date                  | agreed price | status    | effective from               | effective to                 | stop effective from          |
        | employer 1 | 1             | 1-001      | learner a | 01/Aug/Current Academic Year | 28/Aug/Next Academic Year | 15000        | cancelled | 01/Aug/Current Academic Year | 14/Nov/Current Academic Year | 15/Nov/Current Academic Year |
        | employer 2 | 2             | 1-001      | learner a | 15/Nov/Current Academic Year | 28/Aug/Next Academic Year | 5625         | active    | 15/Nov/Current Academic Year |                              |                              |
