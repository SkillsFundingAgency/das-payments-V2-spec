...
#            | Provider 16-18 incentive   | 0     | 0     | 0     | 500   | 0     |
  ...
  # | employer 2 | DAS  | 05/11/2018                |
	Scenario Outline: 1 learner aged 16-18, levy available, changes employer,and incentive payment is earned in transfer month at a date before the transfer date.
...
# Query :  Do we need to include incentive for Provider?  Most probably not ...
	Then the following learner earnings should be generated
		...
		| May/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
		| Jun/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
		| Jul/Current Academic Year | 500          | 1125       | 0         | 0                            | 500                           |

    And at month end only the following payments will be calculated for Employer 1 
	...
	And only the following provider payments will be recorded for Employer 1 										                                                
        | Collection Period         | Delivery Period           | Levy Payments | Transaction Type             |
    ...
    And at month end only the following payments will be calculated for Employer 2
        ...
        | R04/Current Academic Year | Nov/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
        | R05/Current Academic Year | Dec/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
        | R06/Current Academic Year | Jan/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
        | R07/Current Academic Year | Feb/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
        | R08/Current Academic Year | Mar/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
        | R09/Current Academic Year | Apr/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
        | R10/Current Academic Year | May/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
        | R11/Current Academic Year | Jun/Current Academic Year | 500          | 0          | 0         | 0                            | 0                             |
        | R12/Current Academic Year | Jul/Current Academic Year | 500          | 1125       | 0         | 0                            | 500                           |
