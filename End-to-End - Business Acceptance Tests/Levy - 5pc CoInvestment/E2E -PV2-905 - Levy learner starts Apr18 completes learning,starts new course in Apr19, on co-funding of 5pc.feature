...
#
#Scenario: Levy Learner, started learning before Apr19, completes learning and starts new course on new pathway code from Apr19, moves into co-funding and second pathway code on 5% contribution
#
#Background: The example is demonstrating a learner flagged as 'Levy' starts learning pre Apr 2019 completes learning, starts new course on new pathway code in Apr19
#			and moves into co-funding with 5% contribution for second pathway code as its new learning from Apr19
#	
...
#        | 04/18 | 04/18 | 05/16 | ... | 03/19 | 04/19 | 05/19 | ... | 03/20 | 04/20 |
#        | 1000  | 1000  | 1000  | ... | 1000  | 3000  | 0     | ... | 0     | 0     |	
#	
#	And the following commitments exist in April 18:
#        | commitment Id | version Id | ULN       | priority | start date | end date   | agreed price | framework code | programme type | pathway code | status     | effective from | effective to |
#        | 1             | 1          | learner a | 1        | 01/04/2018 | 01/04/2019 | 15000        | 403            | 2              | 1            | completed  | 01/04/2018     | 01/04/2018   |
#		| 1             | 2          | learner a | 1        | 02/04/2019 | 03/04/2019 | 15000        | 403            | 2              | 2            | continuing | 02/04/2018     | 		       |
#	
...
#        | learner a | 03/04/2018 | 01/04/2019       | 31/03/2019      | completed         | 12000                | 03/04/2018                          | 3000                   | 03/04/2018                            | 403            | 2              | 1            |
...
#        | Provider Earned from SFA   		| 1000  | 1000  | 1000  | ... | 1000  | 3950  | 950   | 950   | ... | 950   | 0     |
#        | Provider Earned from Employer 	| 0     | 0     | 0     | ... | 0     | 50    | 50    | 50    | ... | 50    | 0     |            
#		| Provider Paid by SFA       		| 0     | 1000  | 1000  | ... | 1000  | 1000  | 3950  | 950   | ... | 950   | 950   |
#        | Payment due from Employer         | 0     | 0     | 0     | ... | 0     | 0     | 0     | 50    | ... | 50    | 50    | 
#		| Levy account debited       		| 0     | 1000  | 1000  | ... | 1000  | 1000  | 3000  | 0     | ... | 0     | 0     |
#        | SFA Levy employer budget   		| 1000  | 1000  | 1000  | ... | 1000  | 3000  | 0     | 0     | ... | 0     | 0     |
#        | SFA Levy co-funding budget 		| 0     | 0     | 0     | ... | 0     | 950   | 950   | 950   | ... | 950   | 0     |
#		| SFA non-Levy co-funding budget	| 0     | 0     | 0     | ... | 0     | 0     | 0     | 0     | ... | 0     | 0     | 
#
#	And the transaction types for the payments are:
#        | Payment type                 | 05/18 | 06/18 | ... | 03/19 | 04/19 | 05/19 | 06/19 | ... | 03/20 | 04/20 |
#        | On-program                   | 1000  | 1000  | ... | 1000  | 1000  | 950   | 950   | ... | 950   | 950   |
#        | Completion                   | 0     | 0     | ... | 0     | 0     | 3000  | 0     | ... | 0     | 0     |
#        | Balancing                    | 0     | 0     | ... | 0     | 0     | 0     | 0     | ... | 0     | 0     |
#        | Employer 16-18 incentive     | 0     | 0     | ... | 0     | 0     | 0     | 0     | ... | 0     | 0     |
#        | Provider 16-18 incentive     | 0     | 0     | ... | 0     | 0     | 0     | 0     | ... | 0     | 0     |	
#
##April 2019 contains completion payment of £3000 from employer Levy account for first learning, and £950 on program earnings from second learning at 5% contribution		
