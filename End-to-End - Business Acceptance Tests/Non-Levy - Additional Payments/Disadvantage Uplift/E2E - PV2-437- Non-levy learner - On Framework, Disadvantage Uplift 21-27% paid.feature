#Scenario: Payment for a non-DAS learner, lives in a disadvantaged postocde area - 21-27% most deprived, funding agreed within band maximum, UNDERTAKING APPRENTICESHIP FRAMEWORK
#    #The provider incentive for this postcode group is £200 split equally into 2 payments at 90 and 365 days. INELIGIBLE FOR APPRENTICESHIP STANDARDS
...
#        | SFA non-Levy additional payments budget | 0     | 0     | 0     | 150   | 0     | ... | 0     | 100   | 0     |
...
# Notes for DC team : In the ILR  use post codes having deprivation of 21-27% 
    ...
    And the following earnings had been generated for the learner
        | Delivery Period        | On-Programme | Completion | Balancing | 1st-Disadvantage Uplift |
    ...
    And the following provider payments had been generated
        ...
        | R05/Last Academic Year | Dec/Last Academic Year | 0                      | 0                           | 100                       | 1st-Disadvantage Uplift | 
	...
	Then the following learner earnings should be generated
		| Delivery Period           | On-Programme | Completion | Balancing | 2nd-Disadvantage Uplift |
		| Aug/Current Academic Year | 1000         | 0          | 0         | 100                     |
		| Sep/Current Academic Year | 0            | 3000       | 0         | 0                       |

    And only the following payments will be calculated
		| Collection Period         | Delivery Period           | On-Programme | Completion | Balancing | 2nd-Disadvantage Uplift |
	...
	And only the following provider payments will be recorded
		...
		| R01/Current Academic Year | Aug/Current Academic Year | 0                      | 0                           | 100                       | 2nd-Disadvantage Uplift |
