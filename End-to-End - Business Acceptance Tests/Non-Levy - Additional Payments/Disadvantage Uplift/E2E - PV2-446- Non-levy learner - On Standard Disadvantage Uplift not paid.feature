#Scenario: Payment for a non-DAS learner, does not live in a disadvantaged postcode area - no uplift earned, despite them doing a standard
#    Given A Non-Das Learner 
#    And the apprenticeship funding band maximum is 15000
#    When an ILR file is submitted with the following data:
#        | ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | standard code | programme type | home postcode deprivation |
#        | learner a | programme only non-DAS | 15000        | 06/08/2018 | 08/08/2019       |                 | continuing        | 50            | 25             | not deprived             |
...
# Notes for DC team : In the ILR  use post code That does not have a deprivation percentage.
    ...
    And the following earnings had been generated for the learner
        | Delivery Period        | On-Programme | Completion | Balancing | Disadvantage Uplift |
    ...
    And the following provider payments had been generated
        ...
        | R01/Last Academic Year | Aug/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R02/Last Academic Year | Sep/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R03/Last Academic Year | Oct/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R04/Last Academic Year | Nov/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R05/Last Academic Year | Dec/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R06/Last Academic Year | Jan/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R07/Last Academic Year | Feb/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R08/Last Academic Year | Mar/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R09/Last Academic Year | Apr/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R10/Last Academic Year | May/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R11/Last Academic Year | Jun/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
        | R12/Last Academic Year | Jul/Last Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
	...
	Then the following learner earnings should be generated
		| Delivery Period           | On-Programme | Completion | Balancing | Disadvantage Uplift |
		| Aug/Current Academic Year | 1000         | 0          | 0         | 0                   |
		| Sep/Current Academic Year | 0            | 3000       | 0         | 0                   |

    And only the following payments will be calculated
		| Collection Period         | Delivery Period           | On-Programme | Completion | Balancing | Disadvantage Uplift |
		| R01/Current Academic Year | Aug/Current Academic Year | 1000         | 0          | 0         | 0                   |
	...
	And only the following provider payments will be recorded
		...
		| R01/Current Academic Year | Aug/Current Academic Year | 0                      | 0                           | 0                         | Disadvantage Uplift |
