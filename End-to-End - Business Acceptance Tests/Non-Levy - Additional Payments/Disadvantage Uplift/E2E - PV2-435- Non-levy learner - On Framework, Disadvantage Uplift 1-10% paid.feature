...
Scenario Outline:Non-levy learner - on framework , Disadvantage Uplift 1-10% paid
    ...
    And the following provider payments had been generated
        ...
        | R05/Last Academic Year | Dec/Last Academic Year | 0                      | 0                           | 300                       | 1st-Disadvantage Uplift |
    ...
    And only the following payments will be calculated
		| Collection Period         | Delivery Period           | On-Programme | Completion | Balancing | 2nd_Disadvantage Uplift |
	...
	And only the following provider payments will be recorded
		...
		| R01/Current Academic Year | Aug/Current Academic Year | 0                      | 0                           | 300                       | 2nd-Disadvantage Uplift |
