#Scenario: Payment for a non-DAS learner, lives in a disadvantaged postocde area - 11-20% most deprived, funding agreed within band maximum, UNDERTAKING APPRENTICESHIP FRAMEWORK
...
#        | learner a | programme only non-DAS | 15000        | 06/08/2018 | 08/08/2019       |                 | continuing        | 593            | 20             | 1            | 11-20%                    |
#      
...
#		| Provider Earned from SFA                | 900   | 900   | 900   | 1050  | 900   | ... | 900   | 150   | 0     |        
...
# Notes for DC team : In the ILR  use post codes having deprivation of 11-20% 
    ...
    And the following provider payments had been generated
        ...
        | R05/Last Academic Year | Dec/Last Academic Year | 0                      | 0                           | 150                       | Disadvantage Uplift |
	...
	And only the following provider payments will be recorded
		...
		| R01/Current Academic Year | Aug/Current Academic Year | 0                      | 0                           | 150                       | Disadvantage Uplift |
