#Non-Levy apprentice, learner moves start date forward, on prog payments and english/maths will be refunded
#
...
#		
#			| ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | aim type         | aim sequence number | aim rate | framework code | programme type | pathway code |
#			| learner a | programme only non-DAS | 9000         | 06/10/2017 | 20/10/2018       |                 | continuing        | programme        | 2                   |          | 403            | 2              | 1            |
#			| learner a | programme only non-DAS |              | 06/10/2017 | 20/10/2018       |                 | continuing        | maths or english | 1                   | 471      | 403            | 2              | 1            |
#  									    
...
#            | Provider Paid by SFA                    | 0      | 579.25 | 579.25 | 579.25   | 579.25 | 579.25 |
#            | Refund taken by SFA                     | 0      | 0      | 0      | -1158.50 | 0      | 0      |
#            | Payment due from Employer               | 0      | 60     | 60     | -120     | 0      | 0      |
...
#            | SFA non-Levy additional payments budget | 0      | 0      | 39.25  | 39.25    | 39.25  | 39.25  |   
#

# New template
Feature: Non-levy learner, learner moves start date forward, on prog payments and english/maths will be refunded
...
Scenario Outline: Non-levy learner provider changes aim sequence numbers after payments have already occurred PV2-466
    ...
    Then the following learner earnings should be generated
        | Delivery Period           | On-Programme | Completion | Balancing | OnProgrammeMathsAndEnglish |
        | Aug/Current Academic Year | -1200        | 0          | 0         | -78.50                     |
